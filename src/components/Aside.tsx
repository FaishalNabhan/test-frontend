...
const Sidebar: React.FC = () => {
	return (
		<nav className="fixed left-6 top-2/4 z-20 my-10 flex h-[auto] min-w-[64px] shrink-0 grow-0 -translate-y-2/4 flex-col justify-start gap-4 rounded-lg border border-t border-gray-200 bg-white/80 p-2.5 shadow-lg backdrop-blur-sm">
			<a
				href="#analytics"
